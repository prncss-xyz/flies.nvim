...
function mt.__index(_, key)
	...
	if key == "javascriptreact" then
		return require "flies2.ts_queries.javascriptreact"
	end
	...
	if key == "go" then return require "flies2.ts_queries.go" end
	if key == "markdown" then return require "flies2.ts_queries.markdown" end
end
